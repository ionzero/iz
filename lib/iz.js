...
if (typeof module === 'object' && typeof module.parent === 'object' && typeof module.parent.require === 'function') {
    ...
    iz_require = function(path, packagename, callback) {
        ...
        if (loaded_module === false) {
            throw new Error('Unable to locate ' + packagename + '.  Make sure your NODE_PATH is set appropriately');
        }
    ...
    iz_require = function(path, packagename, callback) {
        try {
            ...
            throw new Error('Unable to locate ' + packagename + '.  Make sure your file resolution path is set appropriately');
        }
        var moduletoload = iz.Module(packagename);
        if (callback && typeof callback === 'function') {
            callback(moduletoload);
...
// This breaks loose coupling.  IZ tries paths provided explicitly (if any), then does
// the standard path search.  If you don't provide any paths, it works like any
