...
//    Class['superclass'] = Class._['superclass'];
    Class['get_super'] = function (name) {
    var method = Superclass[name];
        if (name !== undefined) {
            if (typeof(method) === 'function') {
                return function () {
                    return method.apply(this, arguments);
    ...
    var CONS = function () {
        var result = closure(Class, Class.get_super);
        if (result === undefined) {
...
/*
method: obj.get_super(methodname)

Returns the superclass' version of the given method, bound to the current object.  This allows you to 
call the parent-class' method defined by the name provided.  This is most useful when overriding a method
in a subclass.
...
proto.CONSTRUCT = function(args, object_to_localize) {
    ...
    if (this['_on_object_create'] !== undefined && typeof this['_on_object_create'] === 'function') {
        var super_on_object_create = this.get_super('_on_object_create');
        if (typeof super_on_object_create === 'function') {
            super_on_object_create(args);
        }
...
(start code)
module.exports = iz.Package('MyInputStream', { extends: stream.Readable }, function(Class) {
