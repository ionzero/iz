...
iz['package'] = function (packagename, inheritance, closure) {
    ...
    if (inheritance['extends']) {
        if (iz.loaded_packages[inheritance['extends']] === undefined || iz.loaded_packages[inheritance['extends']].constructor === undefined) {
...
proto.has = function (name, detail) {
    ...
    if (this.meta.attributes[name]['ro']) {
        ...
        this[name] = function (value) {
            return this['set_attribute_value'](name, value);
        };
    }
};
...
proto['with'] = function (packagename, overlay_attributes) {
    ...
    if (superclass !== undefined) {
        ...
        for (i = 0; i < overlay_attributes.length; i++) {
            ...
            if (superclass.meta !== undefined && typeof superclass.meta['attributes'] === 'object' && superclass.meta.attributes[attr]) {
