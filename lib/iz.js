...
function iz_require(path, packagename, callback) {
    ...
    if (typeof require === 'function') {
        ...
        // VERY rarely do we want to require from where IZ is.  Chances are
        // we want to require from where whatever called IZ is.  This 
        // makes that happen.  I'm not 100% sure it is correct, quite frankly, but
        // it relies on a stable api that seems to do what we want.
        module.parent.require(path);
        //require(path);
